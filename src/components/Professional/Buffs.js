    ...
    <div className="container my-5 buffs">
      <div className="card bg-secondary">
        ...
        <div className="d-flex mx-5">
          <img src="/buffs_main.png" alt="" className="mx-2 rounded project-image" style={{ width: "49%", height: "auto" }} />
          <img src="/buffs_dashboard.png" alt="" className="mx-2 rounded project-image" style={{ width: "49%", height: "auto" }} />
        </div>
        <div className="card-body">
