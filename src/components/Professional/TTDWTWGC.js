    ...
    <div className="container my-5 ttdwtwgc">
      <div className="card bg-secondary">
        ...
        <div className="d-flex mx-5">
          <img src="/ttdwtwgc_main.png" alt="" className="mx-2 rounded" style={{ width: "49%", height: "auto" }} />
          <img src="/ttdwtwgc_idea.png" alt="" className="mx-2 rounded" style={{ width: "49%", height: "auto" }} />
        </div>
        <div className="card-body">
